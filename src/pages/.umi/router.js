    ...
    routes: [
      {
        path: '/Battle',
        exact: true,
        component: require('../Battle.js').default,
        title: 'Battle',
      },
      {
        path: '/',
      ...
      },
      {
        path: '/ShoppingCart',
        exact: true,
        component: require('../ShoppingCart.js').default,
        title: 'ShoppingCart',
      },
      {
        path: '/sub/a',
      ...
      },
      {
        path: '/sub/model',
        exact: true,
        component: require('../sub/model.js').default,
      },
      {
        path: '/sub/models/temp',
        exact: true,
        component: require('../sub/models/temp.js').default,
      },
      {
        path: '/sub/sub/b',
        exact: true,
